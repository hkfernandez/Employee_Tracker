...
const continueOrMain =[
      {type: 'list', message: `Would you like to continue?`, name: 'choice', choices: ['Continue', 'Return to Main Menu']},
]




module.exports = {boilerplate, addEmployee, addRole, addDept, selectList, continueOrMain}
